    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path
          ...
          fill={active ? 'var(--t-border)' : 'none'}
          stroke={active ? 'var(--t-active)' : '#B8A0B0'}
          strokeWidth="2"
    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <rect
          ...
          fill={active ? 'var(--t-border)' : 'none'}
        />
        <path d="M8 8H16M8 12H16M8 16H12" stroke={active ? 'var(--t-active)' : '#B8A0B0'} strokeWidth="2" strokeLinecap="round" />
        <circle cx="19" cy="19" r="5" fill={active ? 'var(--t-active)' : '#B8A0B0'} />
    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M9 2.5h6v3H9z"
          fill={active ? 'var(--t-active)' : '#B8A0B0'}
        />
    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path
          ...
          fill={active ? 'var(--t-border)' : 'none'}
        />
        <circle cx="8.5"  cy="11.5" r="1" fill={active ? 'var(--t-active)' : '#B8A0B0'} />
        <circle cx="12"   cy="11.5" r="1" fill={active ? 'var(--t-active)' : '#B8A0B0'} />
        <circle cx="15.5" cy="11.5" r="1" fill={active ? 'var(--t-active)' : '#B8A0B0'} />
      </svg>
    ),
  },
]
    ...
    <div style={styles.nav}>
      {visibleTabs.map(tab => {
        ...
        return (
          ...
          >
            {tab.icon(active)}
            <span style={{ ...styles.label, color: active ? 'var(--t-active)' : '#B8A0B0' }}>
              {tab.label}
            </span>
          </button>
        )
...
const styles = {
  nav: {
    display: 'flex',
    background: '#fff',
    borderTop: '1.5px solid var(--t-border)',
